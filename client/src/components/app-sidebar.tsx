...
const UserProfile = () => {
  ...
  />
  <span
    className="absolute bottom-0 right-0 w-3 h-3 bg-green-500 border-2 border-white dark:border-dark-box rounded-full"
    title="Online"
  ></span>
</div>
    ...
    <div className="flex items-center justify-end" onClick={() => setShowBuyCoins(true)}>
      ...
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 text-sm text-black dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-dark-box rounded-md">
