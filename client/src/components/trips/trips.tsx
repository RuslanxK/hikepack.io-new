...
const TripPage: React.FC = () => {
  ...
  return (
    <Fragment>
      ...
      <div className="bg-white p-5 rounded-lg flex justify-between items-center dark:bg-dark-box mb-5">
        <div>
          <h2 className="text-lg font-semibold mb-1">My Last Planned Trips</h2>
          <p className="mb-4">Seamless Trip Planning and Bag Organization Made Simple.</p>
        </div>
