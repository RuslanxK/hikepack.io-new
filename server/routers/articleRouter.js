...
const { getAllArticles, getArticleById, createArticle, deleteArticle } = require("../BL/articleBL");
...
router.put("/:id", async (req, res) => {
  try {
    const updatedArticle = await articleController.updateArticle(req.params.id, req.body);
